...
- 4 `material`s titled as 'MAT*LD*\<COLOR>' that are used to create the level in 'Main Scene'
...
Open your model's scene and attach 'AG*Locomotion' and 'AS*\<MyCharacterName>' to the animation controller component.
